# -*- coding: utf-8 -*-
#
# Address List for Calendar Events documentation build configuration file, created by
# TYPO3 extension sphinx on Wed, 16 Apr 2014 21:38:44 +0200.
#
...
project = u'Address List for Calendar Events'
copyright = u'2014, Michael Oehlhof'
...
latex_documents = [
    ('Index', 'addresslist4cal.tex', u'Address List for Calendar Events',
     u'Michael Oehlhof', 'manual'),
]
...
pdf_documents = [
    ('Index', 'addresslist4cal', u'Address List for Calendar Events',
     u'Michael Oehlhof'),
]
...
texinfo_documents = [
    ('Index', 'addresslist4cal', u'Address List for Calendar Events',
     u'Michael Oehlhof', 'Address List for Calendar Events', 'One line description of project.',
     'Miscellaneous'),
]
